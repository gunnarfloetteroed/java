 ...
 * 
 */
public class MHGPSPathGenerator extends MHPathGenerator implements
		PathGenerator {

	// -------------------- CONSTRUCTION --------------------

	public MHGPSPathGenerator() {
		// no-argument constructor for reflective instantiation
		// TODO but this (and its superclass) is not at all used reflectively!
	}

	@Override
	MHLinkAndPathCost newConfiguredLinkAndPathCost(final Config config) {
		final MHGPSLinkAndPathCost result = new MHGPSLinkAndPathCost();
