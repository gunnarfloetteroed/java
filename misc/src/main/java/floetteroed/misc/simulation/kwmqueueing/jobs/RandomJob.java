...
/**
 * 
 * A job that performs a random walk with uniform turning probabilities,
 * possibly towards a destination.
 * 
 * @author Gunnar Flötteröd
 * 
 */
public class RandomJob implements KWMQueueingSimJob {
	...
	public RandomJob(final String id, final double startTime_s,
